        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            >
              ...
              <h2 className="text-5xl lg:text-7xl font-black text-slate-950 mb-10 leading-[0.8] tracking-[0.25em] uppercase">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-8 p-8 rounded-xl bg-white border border-slate-100 shadow-sm hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div>
                      <div className="text-[10px] font-black tracking-[0.25em] text-slate-400 mb-1 uppercase">{stat.label}</div>
            ...
            >
              ...
              <div className="relative aspect-square rounded-[3rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border-8 border-white group">
                ...
                <div className="absolute top-8 left-8 p-6 bg-white/90 backdrop-blur-xl rounded-2xl border border-white shadow-xl">
                   <div className="text-[9px] font-black text-cyan-600 uppercase tracking-[0.25em] mb-2">Resonance</div>
                   <div className="text-2xl font-black text-slate-950 tracking-[0.25em] uppercase">ELECTRON <br />SYMMETRY</div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-end justify-between mb-24 gap-12">
            <div className="max-w-2xl">
              <div className="text-[10px] font-black text-cyan-400 uppercase tracking-[0.25em] mb-8">Mechanism of Action</div>
              <h2 className="text-5xl lg:text-7xl font-black mb-8 leading-[0.9] tracking-[0.25em] uppercase">
      ...
      <section className="py-24 lg:py-48 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-end justify-between mb-32 gap-12">
            <div className="max-w-2xl">
              <div className="text-[11px] font-black text-cyan-600 uppercase tracking-[0.25em] mb-10">Analytical Comparison</div>
              <h2 className="text-6xl lg:text-7xl font-black text-slate-950 leading-[0.9] tracking-[0.25em] uppercase mb-6">
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-16">
                  <h3 className="text-2xl font-black text-slate-950 uppercase tracking-[0.25em]">{row.title}</h3>
                  <div className="px-6 py-2 text-[10px] font-black uppercase tracking-[0.25em] bg-cyan-950 text-cyan-400 rounded-lg shadow-2xl">
                    {row.status}
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-auto">
                  <div className="space-y-6">
                    <div className="text-[10px] font-black text-cyan-600 uppercase tracking-[0.3em] flex items-center gap-3">
      ...
      <section className="py-24 lg:py-48 px-6 bg-white overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto text-white">
            ...
            <h2 className="text-5xl lg:text-7xl font-black mb-12 leading-[0.9] tracking-[0.25em] uppercase font-heading">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button className="h-16 px-10 rounded-2xl bg-white text-slate-950 hover:bg-cyan-50 text-[11px] font-black uppercase tracking-[0.25em] shadow-xl transition-all hover:scale-105 active:scale-95 border-none">
                Technical Dossier
              </Button>
              <Button variant="outline" className="h-16 px-10 rounded-2xl border-2 border-white/20 text-white hover:bg-white/10 text-[11px] font-black uppercase tracking-[0.25em] transition-all hover:scale-105 active:scale-95">
                Scientific Counsel
              </Button>
            </div>
          </div>
